...
public class InvokeFromOrg2 implements Runnable {
	...
	public InvokeFromOrg2(String threadName, Date s)
	{
	...
	public void run() {
		...
		try {
			...
			EventHub eventHub = fabClient.getInstance().newEventHub("eventhub01", "grpc://localhost:8053");
